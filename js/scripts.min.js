...
$(document).ready(function() {
    $(".wp1").waypoint(function() {
        ...
        $(window).scroll(function(){
            if ($(window).scrollTop() >= 20) {
              ...
              $("header").css({"border-bottom":"none", padding:"25px 0"});
    ...
    var r = createCalendar({
        ...
        data: {
            title: "Runyu and Tianwu's Wedding",
            start: new Date("Aug 17, 2025 11:00"),
            end: new Date("Aug 17, 2025 13:00"),
            address: "Yuechen Hotel, Wafangdian, Dalian",
    ...
    $("#add-to-cal").html(r), $("#rsvp-form").on("submit", function(e) {
        ...
        // Removed invite code MD5 verification, always submit
        $.post("你的腾讯云HTTP触发器URL", t).done(function(e) {
...
function initMap() {
    var map = new AMap.Map('map-canvas', {
        center: [121.97783456315749, 39.626490650648726], // [经度, 纬度]
        zoom: 15
    });
    var icon = new AMap.Icon({
        image: 'img/marker.png', // 你的 marker 图片路径
        size: new AMap.Size(50, 50), // 图标显示大小
        imageSize: new AMap.Size(50, 50) // 图片实际大小
    });
    var marker = new AMap.Marker({
        position: [121.97783456315749, 39.626490650648726],
        title: '大连悦宸酒店（原远洲酒店）',
        icon: icon,
...
function updateCountdown() {
    // 设置婚礼日期时间（2025年8月17日11:58，注意月份从0开始计数）
    const weddingDate = new Date(2025, 7, 17, 11, 58, 0);
    const now = new Date();
    ...
    // 如果婚礼时间已过
    if (diff < 0) {
        if (document.getElementById('countdown-message')) {
            document.getElementById('countdown-message').textContent = "婚礼正在进行中！";
        }
